...
hlBool CSGAFile::MapDataStructures()
{
	...
	{
		LastError.SetErrorMessage("Invalid file: the file map is too small for its header.");
		return hlFalse;
	}
	...
	{
		LastError.SetErrorMessage("Invalid file: the file map is too small for its extended header.");
		return hlFalse;
	}
