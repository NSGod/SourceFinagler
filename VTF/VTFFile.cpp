...
vlBool CVTFFile::ConvertRGBA8888toBGRA8888(vlByte *sourceBytes, vlByte *destBytes, vlUInt pixelCount) {
#if MD_DEBUG
	...
	TKColor32 *sourcePixels = (TKColor32 *)sourceBytes;
	TKColor32 sourcePixel;
	
	TKColor32 *destPixels = (TKColor32 *)destBytes;
	TKColor32 destPixel;
