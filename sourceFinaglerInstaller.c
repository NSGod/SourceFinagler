...
static int VSToolRunLaunchCtl(bool junkStdIO, const char *command, const char *plistPath) {
...
static int VSToolCopyFileOverwriting(const char *sourcePath, mode_t destMode, const char *destPath) {
...
static int VSToolInstallCommand(const char *bundleID, const char *toolSourcePath, const char *plistSourcePath) {
...
static int VSToolEnableCommand(const char *bundleID) {
